...
const Edit = () => {
  ...
  return (
    ...
    <textarea name='description' onChange={ChangeHandler} value={product && product.description} placeholder='enter product description here...' className='text-1xl bg-zinc-100 rounded p-3 w-1/2 mb-3' rows="10"></textarea>
    <div className='w-1/2'>
